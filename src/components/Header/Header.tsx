...
export const Header = () => {
    ...
    return <header className="w-full flex flex-col justify-center">
        ...
        <nav>
            <ul className={`${showMenu ? "flex" : "hidden"} right-0 p-[25px] bg-white absolute md:static gap-[15px] text-end md:text-start md:flex flex-col md:flex-row md:py-[10px] md:justify-center md:gap-[60px] md:text-[12px] uppercase font-[300] `}>
