export const TermsAndCondition = () => {
  return (
    <div className="container mx-auto px-[15px] max-w-[768px] flex flex-col gap-[15px]">
              <h2 className="text-center text-[32px]">
                <strong>Terms and Conditions</strong>
              </h2>
              <p className="text-center text-[18px]">Welcome to Parallels Wear!</p>
              <p>
                These terms and conditions outline the rules and regulations for
                the use of Parallels Wear`s Website, located at
                https://parallelswears.com.
              </p>
              <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Parallels Wear if you do not
              ...
              <p>
                ...
                and subject to, prevailing law of il. Any use of the above
              ...
              <p>
                We employ the use of cookies. By accessing Parallels Wear, you
                agreed to use cookies in agreement with the Parallels Wear`s
                Privacy Policy.{" "}
              </p>
              <p>
              ...
              <p>
                Unless otherwise stated, Parallels Wear and/or its licensors own
                the intellectual property rights for all material on Parallels
                Wear. All intellectual property rights are reserved. You may
                access this from Parallels Wear for your own personal use
                subjected to restrictions set in these terms and conditions.
              </p>
              <p>You must not:</p>
              <ul>
                <li>Republish material from Parallels Wear</li>
                <li>Sell, rent or sub-license material from Parallels Wear</li>
                <li>
                  Reproduce, duplicate or copy material from Parallels Wear
                </li>
                <li>Redistribute content from Parallels Wear</li>
              </ul>
              <p>
              ...
              <p>
                ...
                website. Parallels Wear does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of Parallels Wear,its agents
                and/or affiliates. Comments reflect the views and opinions of
                the person who post their views and opinions. To the extent
                permitted by applicable laws, Parallels Wear shall not be liable
              ...
              <p>
                Parallels Wear reserves the right to monitor all Comments and to
              ...
              <p>
                You hereby grant Parallels Wear a non-exclusive license to use,
              ...
              <p>
                ...
                of Parallels Wear; and (d) the link is in the context of general
              ...
              <p>
                ...
                by sending an e-mail to Parallels Wear. Please include your
              ...
              <p>
                No use of Parallels Wear`s logo or other artwork will be allowed
