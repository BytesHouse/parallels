...
export const PrivacyBlock = () => {
  return (
    ...
    <h1 className="text-center text-[32px]">Privacy Policy</h1>
    <p className="text-center text-[18px]" id="title-company-name">Parallels Wears</p>
    <hr/>
...
<h2 className="text-center text-[25px] font-bold">Interpretation and Definitions</h2>

    <h3 className="mt-4 text-[20px] font-bold">Interpretation</h3>
    <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>

    <h3 className="mt-4 text-[20px] font-bold">Definitions</h3>
<p>
    For the purposes of this Privacy Policy:
    <ul>
    <li><strong>Company </strong>(referred to as either `the Company`, `We`, `Us` or `Our` in this Agreement) refers to <span id="company-name">Parallels Wears</span>.</li>
...
<h2 className="text-center text-[25px] font-bold">Collecting and Using Your Personal Data</h2>
<h3 className="mt-4 text-[20px] font-bold">Types of Data Collected</h3>
    <h5>Personal Data</h5>
...
<ul>
    ...
    <h3 className="mt-4 text-[20px] font-bold">Use of Your Personal Data</h3>
    <p>
...
<ul>
    ...
    <h3 className="mt-4 text-[20px] font-bold">Retention of Your Personal Data</h3>
    ...
    <h3 className="mt-4 text-[20px] font-bold">Transfer of Your Personal Data</h3>
...
The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in accordance with this Privacy Policy and no transfer of Your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of Your data and other personal information.
    ...
    <h3 className="mt-4 text-[20px] font-bold">Disclosure of Your Personal Data</h3>
...
<ul>
    ...
    <h3 className="mt-4 text-[20px] font-bold">Security of Your Personal Data</h3>
    <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>

    <h2 className="text-center text-[25px] font-bold">Links to Other Websites</h2>
<p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party`s site. We strongly advise You to review the Privacy Policy of every site You visit.
    ...
    <h2 className="text-center text-[25px] font-bold">Changes to this Privacy Policy</h2>
<p>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.
    ...
    <br /><br />This Privacy Policy was last updated on <span id="gen-at">2023/11/07 19:31:45</span>
</p>


    <h2 className="text-center text-[25px] font-bold">Contact Us</h2>
If you have any questions about this Privacy Policy, You can contact us via email at <span id="email">parallelswear@gmail.com
    </span>
    <hr/>
